...
import type { AnalyticsPreferences } from "./core/analytics/preferences";
...
interface AnalyticsGuardContext {
  ...
  setPreferences: (updates: Partial<AnalyticsPreferences>) => AnalyticsPreferences;
  reloadPreferences: () => AnalyticsPreferences;
}
